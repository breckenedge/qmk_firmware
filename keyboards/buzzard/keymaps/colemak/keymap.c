...
//  */
    [_BASE] = LAYOUT(
      ...
      UC_OSFT, GUI_A  , ALT_R  , CTL_S  , SHT_T  , KC_G   ,                                        KC_M   , SFT_N  , CTL_E  , ALT_I  , GUI_O, KC_DEL,
      CTL_ESC, KC_Z   , KC_X , KC_C   , KC_D   , KC_V   ,                                        KC_K   , KC_H   , KC_COMM, KC_DOT, KC_SLSH, ADJL  ,
